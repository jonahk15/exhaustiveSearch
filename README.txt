...
This program exhaustively searches all possible permutations of expressions (either bitwise or arithmetic), and prints out only the expressions that evaluate to a target value chosen by the user.
...
Flags are used in the command line to run this program. Order of flags do not matter, and
their significance is provided if the user wants to adjust the Makefile for different test
cases.
